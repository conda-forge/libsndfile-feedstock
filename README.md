...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/libsndfile-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/libsndfile-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi global install libsndfile
```
...
It is possible to list all of the versions of `libsndfile` available on your platform:
...
```
pixi search libsndfile --channel conda-forge
```
